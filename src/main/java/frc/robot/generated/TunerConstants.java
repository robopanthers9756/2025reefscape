...
public class TunerConstants {
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.87);

    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    private static final double kCoupleRatio = 3.4;

    private static final double kDriveGearRatio = 6.557142857142858;
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.423828125);
